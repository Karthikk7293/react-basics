...
const Banner = () => {
    return (
        <div className=' bg-slate-200 h-screen pt-32'>
            ...
            <div className=" w-5/6 mx-auto py-3 ">
               ...
               <div className='text-center pt-5'>
                <button className='border shadow rounded-sm px-3 py-1 uppercase text-xs border-green-300 bg-green-400 text-white'>ping me</button>
               </div>
            </div>
            <div className=" mx-auto flex justify-center items-center w-full ">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2YXoZKi6l7P0Lm952zHtLWLvLdiZxrhyjuQ&s" alt="banner" />
            </div>
